...
console.log("Q: "+query)
        ...
        if (availability != undefined)
        {
            for (let row in cards)
            {
                ...
                {
                    console.log(cards[row]["Availability"].includes(availability))
                    console.log("cards: "+cards[row]["Availability"])
